    ...
    config = function()
      require("bufferline").setup({
        ...
        highlights = {
          ...
          buffer_selected = { fg = "#61afef", bg = "#1e222a", bold = true, italic = false },
          ...
          buffer = { fg = "#5c6370", bg = "#282c34" },
          modified = { fg = "#e5c07b", bg = "#282c34" },
          modified_selected = { fg = "#e5c07b", bg = "#1e222a" },
          modified_visible = { fg = "#e5c07b", bg = "#282c34" },
        },
      })
    end,
  },
